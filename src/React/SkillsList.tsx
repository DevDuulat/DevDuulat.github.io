...
const SkillsList = () => {
  ...
  const skills = {
    "Web Development": [
      ...
      "Developing responsive landing pages and corporate websites",
      "Creating personal and professional portfolio websites",
    ],

    "UI/UX Design & Prototyping": [
      "Designing user interfaces in Figma",
      "Conducting UX research and optimizing user flows",
